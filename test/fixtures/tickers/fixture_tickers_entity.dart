...
import 'package:crypto_pricing/domain/entities/tickers/coin_lore_tickers_data.dart';
import 'package:crypto_pricing/domain/entities/tickers/coin_lore_tickers_info.dart';

const fixtureCoinLoreTickers = CoinLoreTickersEntity(
  data: [
    fixtureBtcData,
    fixtureEthData,
  ],
...
const fixtureBtcData = CoinLoreTickersDataEntity(
  id: "90",
  symbol: "BTC",
  name: "Bitcoin",
  nameid: "bitcoin",
...
const fixtureEthData = CoinLoreTickersDataEntity(
  id: "80",
  symbol: "ETH",
  name: "Ethereum",
  nameid: "ethereum",
...
const fixtureInfoData = CoinLoreTickersInfoEntity(
  coinsNum: 5915,
  time: 1619496963,
);
